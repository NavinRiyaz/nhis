...
<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand">
            <a href=".">
                <img src="<?= base_url('assets/img/logo_white.png') ?>" width="110" height="32" alt="Logo" class="navbar-brand-image">
            </a>
        </h1>
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                    ...
                    <div class="d-none d-xl-block ps-2">
                        ...
                        <div class="mt-1 small text-muted"><?= session()->get('role') ?></div>
                    </div>
                </a>
            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false" >
                      <span class="nav-link-icon d-md-none d-lg-inline-block">
                        ...
                        <span class="nav-link-title">Add Entry</span>
                    </a>
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="<?= base_url('uiic/reimbursement-entry') ?>">
                                    Reimbursement Entry
                                </a>
                            </div>
                        </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="<?= base_url('uiic/reimbursement-report') ?>">
                                    Reimbursement
                                </a>
                            </div>
                        </div>
        ...
        <!--DISTRICT-->
        <?php if (session()->get('role') == 'DISTRICT'): ?>
            <div class="collapse navbar-collapse" id="sidebar-menu">
                <ul class="navbar-nav pt-lg-3">
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url('') ?>" >
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <span class="nav-link-icon d-md-none d-lg-inline-block">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item" href="<?= base_url('district/reimbursement-entry') ?>">
                                        Reimbursement Entry
                                    </a>
                                </div>
                            </div>
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <span class="nav-link-icon d-md-none d-lg-inline-block">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item" href="<?= base_url('district/reimbursement-report') ?>">
                                        Reimbursement
                                    </a>
                                </div>
                            </div>
