...
<div class="page-wrapper">
    ...
    <div class="page-body">
        <div class="container-xl">
            <form action="<?= base_url('district/pensioner_reimbursement-entry') ?>" method="post" autocomplete="off"
                            ...
                            <div class="form-selectgroup-boxes row">
                                <div class="col-md-12">
                                    <label class="form-selectgroup-item">
                                        <input type="radio" name="employee_type" id="state" value="3"
                                        ...
                                        <span class="form-selectgroup-label d-flex align-items-center p-3">
                                            ...
                                            <span class="form-selectgroup-label-content">
                                                <span class="form-selectgroup-title strong mb-1">Pensioner Employee</span>
                                            </span>
                                        </span>
                                    </label>
                                </div>
                ...
                <div class="card step-pane" id="emp_details">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <label class="form-label required" for="emp_id">Pensioner ID</label>
